  ...
  on_supported_os.each do |os, facts|
    context "on #{os} based operating systems" do
      ...
      context 'with a single domain' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_unless "/usr/local/sbin/letsencrypt-domain-validation #{pathprefix}/etc/letsencrypt/live/foo.example.com/cert.pem 'foo.example.com'"
        }
      end
      ...
      context 'with ensure absent' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_onlyif "/usr/local/sbin/letsencrypt-domain-validation #{pathprefix}/etc/letsencrypt/live/foo.example.com/cert.pem 'foo.example.com'"
        }
      end
      ...
      context 'with multiple domains' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a standalone --cert-name 'foo' -d 'foo.example.com' -d 'bar.example.com' -d '*.example.com'"
        }
      end
      ...
      context 'with custom cert-name' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a standalone --cert-name 'bar.example.com' -d 'foo'"
        }
      end
      ...
      context 'with custom command' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command '/usr/lib/letsencrypt/letsencrypt-auto --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a standalone --cert-name \'foo.example.com\' -d \'foo.example.com\''
        }
      end
      ...
      context 'with webroot plugin' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a webroot --cert-name 'foo.example.com' --webroot-path /var/www/foo -d 'foo.example.com'"
        }
      end
      ...
      context 'with webroot plugin and multiple domains' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a webroot --cert-name 'foo' --webroot-path /var/www/foo -d 'foo.example.com' --webroot-path /var/www/bar -d 'bar.example.com'"
        }
      end
      ...
      context 'with webroot plugin, one webroot, and multiple domains' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a webroot --cert-name 'foo' --webroot-path /var/www/foo -d 'foo.example.com' -d 'bar.example.com'"
        }
      end
      ...
      context 'with dns-rfc2136 plugin' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a dns-rfc2136 --cert-name 'foo.example.com' -d 'foo.example.com' --dns-rfc2136-credentials /etc/letsencrypt/dns-rfc2136.ini --dns-rfc2136-propagation-seconds 10"
        }
      end
      ...
      context 'with dns-ovh plugin' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a dns-ovh --cert-name 'foo.example.com' -d 'foo.example.com' --dns-ovh-credentials /etc/letsencrypt/dns-ovh.ini --dns-ovh-propagation-seconds 30"
        }
      end
      ...
      context 'with dns-route53 plugin' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a dns-route53 --cert-name 'foo.example.com' -d 'foo.example.com' --dns-route53-propagation-seconds 10"
        }
      end
      ...
      context 'with custom plugin' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a apache --cert-name 'foo.example.com' -d 'foo.example.com'"
        }
      end
      ...
      context 'with custom puppet_vardir path and manage_cron' do
        ...
        it {
          is_expected.to contain_file('/tmp/custom_vardir/letsencrypt/renew-foo.example.com.sh').with_ensure('file').with_content("#!/bin/sh\nexport VENV_PATH=/opt/letsencrypt/.venv\nletsencrypt --keep-until-expiring --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a apache --cert-name 'foo.example.com' -d 'foo.example.com'\n")
        }
      end
      ...
      context 'without plugin' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 --cert-name 'foo.example.com' -d 'foo.example.com'"
        }
      end
      ...
      context 'when specifying additional arguments' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_command "letsencrypt --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a standalone --cert-name 'foo.example.com' -d 'foo.example.com' --foo bar --baz quux"
        }
      end
      ...
      context 'with custom environment variables and manage_cron' do
        ...
        it { is_expected.to compile.with_all_deps }
        it {
          is_expected.to contain_file('/var/lib/puppet/letsencrypt/renew-foo.example.com.sh').with_content "#!/bin/sh\nexport VENV_PATH=/opt/letsencrypt/.venv\nexport FOO=bar\nexport FIZZ=buzz\nletsencrypt --keep-until-expiring --text --agree-tos --non-interactive certonly --rsa-key-size 4096 -a standalone --cert-name 'foo.example.com' -d 'foo.example.com'\n"
        }
      end
      ...
      context 'with custom config_dir' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_unless '/usr/local/sbin/letsencrypt-domain-validation /foo/bar/baz/live/foo.example.com/cert.pem \'foo.example.com\''
        }
      end
      ...
      context 'on FreeBSD', if: facts[:os]['name'] == 'FreeBSD' do
        ...
        it {
          is_expected.to contain_exec('letsencrypt certonly foo.example.com').with_unless '/usr/local/sbin/letsencrypt-domain-validation /usr/local/etc/letsencrypt/live/foo.example.com/cert.pem \'foo.example.com\''
        }
      end
    end
  end
